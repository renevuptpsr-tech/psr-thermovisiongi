...
_ROUTES = {
    ...
    "GENERAL_CLAMP_CONDUCTOR": AnalysisRoute("GENERAL_CLAMP_CONDUCTOR", "THERMOVISI_GENERAL_V1", "COMPARISON_PAIR"),
    "GENERAL_NETA_PHASE": AnalysisRoute("GENERAL_NETA_PHASE", "THERMOVISI_GENERAL_V1", "PHASE_GROUP"),
}
